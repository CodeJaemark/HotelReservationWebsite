            ...
            <div class="card mb-4 border-0 shadow ">
                <div class="row g-0 p-3 align-items-center">
                    <div class="col-md-5 mb-lg-0 mb-md-0 mb-3">
                        <br>
                        <img src="images/rooms/9a.png" class="img-fluid rounded">

                    </div>
                     <div class="col-md-5 px-lg-3 px-md-3 px-0">
                    <br>
                     <h5 class="mb-3 fw-bold ">Presidential room</h5>
                     
                     <br>
                                <h6 class="mb-4 fw-bold">₱7000 per night</h6>
   ...
   <!-- Carousel -->
    ...
    <div class="swiper-wrapper">
      <div class="swiper-slide">
        <img src="images/carousel/r7a.png" class="w-100 d-block" />
      </div>
      <div class="swiper-slide">
        <img src="images/carousel/r7b.png" class="w-100 d-block"/>
      </div>
      <div class="swiper-slide">
        <img src="images/carousel/r7c.png" class="w-100 d-block" />
      </div>
      <div class="swiper-slide">
        <img src="images/carousel/r7d.png" class="w-100 d-block" />
      </div>
