...
adminLogin();
    ...
    if (isset($frm_data['seen']) && $frm_data['seen'] == 'all') {
         $q = "UPDATE rating_room1 SET seen=?";
        $values = [1];  
        ...
        if (isset($frm_data['seen'])) {
            $q = "UPDATE rating_room1 SET seen=? WHERE sr_no=?";
        ...
        if (isset($_GET['del'])) {
            ...
            if ($frm_data['del'] == 'all') {
                ...
                $q = "DELETE FROM rating_room1 WHERE sr_no=?";
...
<head>
    ...
    <title>Admin Panel - Room1 Ratings</title>
...
<body class="bg-light">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <h3 class="mb-4">Standard Room</h3>
            <!-- Carousel Section -->
                        ...
                        <div class="card border-0 shadow-sm mb-4">
                            ...
                            <div class="table-responsive-md" style="height:450px; overflow-y: scroll;">
                                <table class="table table-hover border">
                                        ...
                                        <tbody>
                                           <?php
                                                $q = "SELECT * FROM rating_room1 ORDER BY sr_no DESC";
