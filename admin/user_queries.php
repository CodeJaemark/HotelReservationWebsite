...
adminLogin();
    if (isset($_GET['seen'])) {
        ...
        if ($frm_data['seen'] == 'all') {
            ...
            $values = [1];  // Corrected $$frm_data to $frm_data
            ...
            $values = [1, $frm_data['seen']];  // Corrected $$frm_data to $frm_data
                                        ...
                                        <tbody>
                                           <?php
                                                ...
                                                while ($row = mysqli_fetch_assoc($data)) {
                                                    $markAsReadBtn = ($row['seen'] != 1) ? "<a href='?seen=$row[sr_no]' class='btn btn-sm rounded-pill btn-primary custom-bg'>Mark as read</a>" : "";
